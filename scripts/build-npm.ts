...
await build({
  entryPoints: [
    ...
    { name: "./webhooks/service", path: "./src/webhooks/service.ts" },
    { name: "./webhooks/in/service", path: "./src/webhooks/in/service.ts" },
    { name: "./webhooks/in/source", path: "./src/webhooks/in/source.ts" },
    { name: "./webhooks/out/service", path: "./src/webhooks/out/service.ts" },
    { name: "./webhooks/out/sender", path: "./src/webhooks/out/sender.ts" },
    { name: "./webhooks/out/bridge", path: "./src/webhooks/out/bridge.ts" },
  ],
  outDir: "./npm",
  shims: { deno: false },
  test: false,
