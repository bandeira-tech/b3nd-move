...
resolver. Speaks the [Connect protocol](https://connectrpc.com/): JSON or binary
protobuf over plain HTTP/1.1 or HTTP/2.
...
`bytes` fields are base64-encoded automatically in JSON mode by
`@bufbuild/protobuf`.
